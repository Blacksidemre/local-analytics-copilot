# Historical two-repository Hermetic adapter boundary

> **Archived/deprecated.** Canonical integration now lives in `apps/desktop` in this repository.
> This file is retained only to explain the earlier bridge boundary.
