# Historical Hermetic upstream security policy

> **Archived/deprecated.** Do not use the reporting URL below for Local Analytics Copilot. Current
> policy and reporting guidance live in repository root [`SECURITY.md`](../../SECURITY.md).
