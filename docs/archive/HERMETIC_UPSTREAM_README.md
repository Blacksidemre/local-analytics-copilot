# Historical Hermetic upstream README

> **Archived/deprecated documentation.** This snapshot accompanied the Hermetic-derived source at
> consolidation time. Its clone URLs, release process, providers and commands do not describe the
> canonical Local Analytics Copilot product. Use the repository root [`README.md`](../../README.md)
> for current instructions. It remains here only for provenance and attribution.
